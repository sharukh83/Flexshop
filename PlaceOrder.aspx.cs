...
public partial class PlaceOrder : System.Web.UI.Page
{
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                if (Session["Buyitems"] == null)
                {
                    ...
                    dr["category"] = Request.QueryString["mat"];
    ...
    public void findorderid()
    {
        ...
        String orderid;
        orderid = " AMD" + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString() + new string(mypass);
        saveaddress();
        Label3.Text = orderid;
    ...
    public void saveaddress()
    {
        ...
        String mycon1 = @"Data Source=DESKTOP-QDN2ODB\SQLEXPRESS;Initial Catalog=mmk;Integrated Security=True";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Shoppingbill.aspx?orderid="+Label3.Text);
        ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('order successful done')", true);
    }
